    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-white/40 mt-1">Inter-school environmental impact rankings</p>
        </div>
        ...
        <div className="flex items-center space-x-3 px-4 py-2 bg-eco-green/10 border border-eco-green/20 rounded-2xl">
          ...
          <div>
            <p className="text-[10px] text-eco-green font-bold uppercase tracking-widest leading-none">Your School Rank</p>
            <p className="text-xl font-bold text-white leading-tight">#1 <span className="text-xs font-normal text-white/40 ml-1">Overall</span></p>
          </div>
        </div>
      </div>
          ...
          {schools?.map((school, index) => (
            <div key={school.name} className="bg-white/5 border border-white/10 p-5 rounded-2xl flex items-center justify-between group hover:border-white/20 transition-all">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h4 className="font-bold text-white text-sm">{school.name}</h4>
