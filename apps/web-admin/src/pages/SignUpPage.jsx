      ...
      >
        <div className="surface-glass p-10 rounded-[40px] border border-white/10 shadow-3xl relative">
          ...
          <div className="flex flex-col items-center text-center mb-10 mt-2">
            ...
            <h1 className="text-2xl font-black text-white tracking-tight uppercase">JOIN <span className="text-eco-teal">THE MISSION</span></h1>
            <p className="text-[11px] text-white/30 font-medium mt-2">Create your decentralized ecological identity</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-white/40 uppercase tracking-[0.2em] ml-1">Security Phrase</label>
              <input 
                required
                type="password" 
            ...
            >
              {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : 'GENERATE IDENTITY'}
            </button>
          </form>

          <div className="relative my-8">
            <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-white/5" /></div>
            <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-widest"><span className="bg-[#0D1117] px-4 text-white/20">OR RAPID JOIN</span></div>
          </div>

          <button onClick={handleGoogleSignup} className="w-full py-4 bg-white/5 border border-white/10 hover:bg-white/10 text-white/80 text-xs font-bold rounded-2xl transition-all flex items-center justify-center gap-3">
